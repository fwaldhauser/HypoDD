...
file_sta='hypoDD.sta'; 
file_line='';
phiA=142.7; xshift=0.1; yshift=0; box_l=1.5; box_w=0.2;
axlim=1; minmag=10; id=[]; itake=[]; err=0;
...
plot(x,y,'o','markersize',5,'color','r');
...
plot((x0*cos(phiA)-y0*sin(phiA)),z0,'o','markersize',5,'color','r');
