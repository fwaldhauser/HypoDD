...
% Change parameters at the beginning of the script. 

%--- file names:
% geography (lines of lon, lat; separators are Nan, NaN):
file_line='';		
% hypocenter file:
...
%--- cross section:
phiA= 150;    	% strike of cross section 
xshift= 0.0;	% x-location 
yshift= 0;	% y-location 
box_l= 2.3; 	% length 
box_w= 0.7; 	% half width

%--- event selection:
axlim= 1.4;  	% axis dimension of map view plot 
minmag= 1;	% circle events with mag>minmag
